...
export default function ProjectsBrief() {
  ...
  return (
    <section className="md:row-start-2 md:row-end-2 md:col-end-3 lg:row-start-2 lg:row-end-4 flex flex-col md:justify-between lg:justify-center h-[30%] md:h-full w-full gap-4 md:gap-0 lg:gap-2 animate-opacityIn animation-delay-800 py-2">
