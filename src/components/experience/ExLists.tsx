...
export default function ExLists() {
  ...
  return (
    <div className="flex flex-row lg:flex-col justify-start w-full lg:w-[20%] h-[10%] md:h-[10%] lg:h-[60%] border-0 md:border-r-[1px] border-zinc-300 gap-6  lg:gap-2 px-2">
      <button
