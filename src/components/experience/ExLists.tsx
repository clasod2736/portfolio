  ...
  return (
    <div className="flex flex-row lg:flex-col justify-start w-full lg:w-[20%] h-[10%] md:h-[10%] lg:h-[60%] border-r-[1px] border-zinc-300 gap-6  lg:gap-2 px-2">
      <button
        ...
        className={` md:text-lg xl:text-xl h-full lg:h-[20%] dark:hover:bg-zinc-600 hover:bg-zinc-100  hover:border-l-8 transition-all text-center md:text-right px-4  animate-slideToRight ${
